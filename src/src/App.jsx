...
export default function App() {
  ...
  const S = {
    body: { margin: 0, fontFamily: "'Poppins', 'Segoe UI', sans-serif", background: "#ffffff", color: "#000000", minHeight: "100vh" },
    nav: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "16px 28px", background: "#ffffff", borderBottom: "1px solid #e0e0e0" },
    ...
    hero: { textAlign: "center", padding: "70px 20px 50px", background: "linear-gradient(135deg, #ffffff 0%, #f5f5f5 55%, #ffffff 100%)" },
    ...
    tickerSection: { padding: "26px 0", background: "#ffffff", borderTop: "1px solid #e0e0e0", borderBottom: "1px solid #e0e0e0", overflow: "hidden" },
