...
const PRODUCTOS_INICIALES = [
  { id: 1, nombre: "Auriculares Bluetooth Pro", precio: 18500, foto: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400&q=80", stock: true,  cantidadStock: 3, categoria: "Electrónica", descripcion: "Auriculares inalámbricos con cancelación de ruido, 30hs de batería.", diasEstimados: "" },
  { id: 2, nombre: "Smartwatch Serie 9",        precio: 42000, foto: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400&q=80", stock: true,  cantidadStock: 2, categoria: "Electrónica", descripcion: "Reloj inteligente con GPS, monitor cardíaco y 7 días de batería.",    diasEstimados: "" },
...
const PROD_VACIO = { nombre:"", precio:"", foto:"", stock:true, cantidadStock:"", categoria:"", descripcion:"", diasEstimados:"" };

export default function GangaStore() {
  const [productos, setProductos]     = useLS("gs_productos", PRODUCTOS_INICIALES);
  const [pedidos,   setPedidos]       = useLS("gs_pedidos",   []);
  ...
  const filtrados  = productos.filter(p=>(catActiva==="Todas"||p.categoria===catActiva)&&p.nombre.toLowerCase().includes(busqueda.toLowerCase()));
  ...
  const guardarProducto = () => {
    if (!formProd.nombre||!formProd.precio||!formProd.categoria){ showToast("Nombre, precio y categoría son obligatorios","error"); return; }
    const prod = { ...formProd, id:editId??uid(), precio:parseFloat(formProd.precio)||0, cantidadStock:parseInt(formProd.cantidadStock)||0, stock:formProd.stock===true||formProd.stock==="true" };
      ...
      <div className="modal">
        ...
        <div className="mb">
          <div className="fg">
            ...
            <div className="fgr"><label>Categoría <span>*</span></label><input type="text" value={formProd.categoria} onChange={e=>setFormProd({...formProd,categoria:e.target.value})} placeholder="Electrónica, Accesorios..." /></div>
